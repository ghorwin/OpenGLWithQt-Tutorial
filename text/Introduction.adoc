...
Diese Anleitung soll auch *_nicht_* zeigen, wie man mit Qt ein Spiel- oder eine Spieleengine schreibt. Es geht eher um technische Anwendungen, in denen _Animationen keine Rolle spielen_. Fokus liegt eher darauf, resourcenschonend (und damit Laptop-Akku-schonend) 3D Grafik zu verwenden.
